...
async def auto_send_loop(context: ContextTypes.DEFAULT_TYPE):
    """Send message to all groups every 3 seconds"""
    config = load_config()
    ...
    # Randomly select a group to send to
...
# START AUTO-SEND
# ============================================================
async def start_auto_send(application):
    ...
    if job_queue:
        job_queue.run_repeating(auto_send_loop, interval=interval, first=3)
...
async def addgroup(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text(
            format_with_emojis(f"✅ 𝐆𝐫𝐨𝐮𝐩 {group_id} 𝐚𝐝𝐝𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲!"),
            parse_mode="HTML"
        )
    except ValueError:
        await update.message.reply_text(
...
async def setmessage(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not context.args:
        await update.message.reply_text(
            format_with_emojis("𝐔𝐬𝐚𝐠𝐞: /setmessage 𝐘𝐎𝐔𝐑 𝐌𝐄𝐒𝐒𝐀𝐆𝐄 𝐇𝐄𝐑𝐄"),
            parse_mode="HTML"
        )
        return
    ...
    await update.message.reply_text(
        format_with_emojis("✅ 𝐌𝐞𝐬𝐬𝐚𝐠𝐞 𝐮𝐩𝐝𝐚𝐭𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲!"),
        parse_mode="HTML"
    )
...
async def setinterval(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if interval < 1:
            await update.message.reply_text(
                format_with_emojis("❌ 𝐈𝐧𝐭𝐞𝐫𝐯𝐚𝐥 𝐦𝐮𝐬𝐭 𝐛𝐞 >= 𝟏 𝐬𝐞𝐜𝐨𝐧𝐝!"),
                parse_mode="HTML"
            )
            return
        ...
        await update.message.reply_text(
            format_with_emojis(f"✅ 𝐈𝐧𝐭𝐞𝐫𝐯𝐚𝐥 𝐬𝐞𝐭 𝐭𝐨 {interval} 𝐬𝐞𝐜𝐨𝐧𝐝𝐬!"),
            parse_mode="HTML"
        )
        
        # Restart the job with new interval
        await update.message.reply_text(
            format_with_emojis("⚠️ 𝐑𝐞𝐬𝐭𝐚𝐫𝐭 𝐛𝐨𝐭 𝐟𝐨𝐫 𝐧𝐞𝐰 𝐢𝐧𝐭𝐞𝐫𝐯𝐚𝐥 𝐭𝐨 𝐭𝐚𝐤𝐞 𝐞𝐟𝐟𝐞𝐜𝐭!"),
            parse_mode="HTML"
        )
    except ValueError:
        await update.message.reply_text(
...
async def groups(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not groups_list:
        await update.message.reply_text(
            format_with_emojis("📭 𝐍𝐨 𝐠𝐫𝐨𝐮𝐩𝐬 𝐚𝐝𝐝𝐞𝐝!"),
            parse_mode="HTML"
        )
        return
...
async def users(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not users_data:
        await update.message.reply_text(
            format_with_emojis("📭 𝐍𝐨 𝐮𝐬𝐞𝐫𝐬 𝐟𝐨𝐮𝐧𝐝!"),
            parse_mode="HTML"
        )
        return
...
async def ban_user(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text(
            format_with_emojis("❌ 𝐈𝐧𝐯𝐚𝐥𝐢𝐝 𝐔𝐬𝐞𝐫 𝐈𝐃!"),
            parse_mode="HTML"
        )
...
async def unban_user(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if target_id in banned:
            ...
            await update.message.reply_text(
                format_with_emojis(f"❌ 𝐔𝐬𝐞𝐫 {target_id} 𝐢𝐬 𝐧𝐨𝐭 𝐛𝐚𝐧𝐧𝐞𝐝!"),
                parse_mode="HTML"
            )
    except:
        await update.message.reply_text(
...
📌 𝐅𝐞𝐚𝐭𝐮𝐫𝐞𝐬:
✅ 𝐀𝐮𝐭𝐨-𝐬𝐞𝐧𝐝𝐬 𝐦𝐞𝐬𝐬𝐚𝐠𝐞𝐬 𝐞𝐯𝐞𝐫𝐲 𝟑𝐬
✅ 𝐌𝐮𝐥𝐭𝐢𝐩𝐥𝐞 𝐠𝐫𝐨𝐮𝐩 𝐬𝐮𝐩𝐩𝐨𝐫𝐭
✅ 𝐏𝐡𝐨𝐭𝐨 + 𝐭𝐞𝐱𝐭 𝐬𝐮𝐩𝐩𝐨𝐫𝐭
...
def main():
    ...
    # Start auto-send
    asyncio.create_task(start_auto_send(application))
