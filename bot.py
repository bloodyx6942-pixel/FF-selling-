...
async def auto_send(context: ContextTypes.DEFAULT_TYPE):
    ...
    only_text = config.get("only_text", False)
    
    # Randomly select a group
    group_id = random.choice(groups)
    
    try:
        if only_text or not photo_url:
            # Only text mode
            ...
            logger.info(f"Sent text to group {group_id}")
        else:
            # Photo + text mode
            ...
            logger.info(f"Sent photo to group {group_id}")
...
📌 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬:
/𝐬𝐭𝐚𝐫𝐭𝐬𝐞𝐧𝐝𝐢𝐧𝐠 - 𝐒𝐭𝐚𝐫𝐭 𝐚𝐮𝐭𝐨-𝐬𝐞𝐧𝐝
/𝐬𝐭𝐨𝐩𝐬𝐞𝐧𝐝𝐢𝐧𝐠 - 𝐒𝐭𝐨𝐩 𝐚𝐮𝐭𝐨-𝐬𝐞𝐧𝐝
/𝐨𝐧𝐥𝐲𝐭𝐞𝐱𝐭 - 𝐎𝐧𝐥𝐲 𝐭𝐞𝐱𝐭 𝐦𝐨𝐝𝐞 (𝐧𝐨 𝐩𝐡𝐨𝐭𝐨)
/𝐩𝐡𝐨𝐭𝐨𝐭𝐞𝐱𝐭 - 𝐏𝐡𝐨𝐭𝐨 + 𝐭𝐞𝐱𝐭 𝐦𝐨𝐝𝐞

👑 𝐎𝐰𝐧𝐞𝐫 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬:
/𝐚𝐝𝐝𝐠𝐫𝐨𝐮𝐩 𝐈𝐃 - 𝐀𝐝𝐝 𝐠𝐫𝐨𝐮𝐩
/𝐫𝐞𝐦𝐨𝐯𝐞𝐠𝐫𝐨𝐮𝐩 𝐈𝐃 - 𝐑𝐞𝐦𝐨𝐯𝐞
/𝐬𝐞𝐭𝐦𝐞𝐬𝐬𝐚𝐠𝐞 - 𝐒𝐞𝐭 𝐦𝐞𝐬𝐬𝐚𝐠𝐞
/𝐬𝐞𝐭𝐩𝐡𝐨𝐭𝐨 - 𝐒𝐞𝐭 𝐩𝐡𝐨𝐭𝐨 𝐔𝐑𝐋
...
# ============================================================
# /startsending - START AUTO SENDING
# ============================================================
async def startsending(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not groups:
        await update.message.reply_text(
            format_with_emojis("❌ 𝐍𝐨 𝐠𝐫𝐨𝐮𝐩𝐬 𝐚𝐝𝐝𝐞𝐝! 𝐔𝐬𝐞 /𝐚𝐝𝐝𝐠𝐫𝐨𝐮𝐩 𝐟𝐢𝐫𝐬𝐭."),
            parse_mode="HTML"
        )
        return
    ...
    await update.message.reply_text(
        format_with_emojis(f"""✅ 𝐀𝐔𝐓𝐎-𝐒𝐄𝐍𝐃𝐈𝐍𝐆 𝐒𝐓𝐀𝐑𝐓𝐄𝐃!

📊 𝐆𝐫𝐨𝐮𝐩𝐬: {len(groups)}
⏱️ 𝐈𝐧𝐭𝐞𝐫𝐯𝐚𝐥: {config.get('interval', 3)}𝐬
📝 𝐌𝐨𝐝𝐞: {'𝐎𝐧𝐥𝐲 𝐓𝐞𝐱𝐭' if config.get('only_text', False) else '𝐏𝐡𝐨𝐭𝐨 + 𝐓𝐞𝐱𝐭'}

𝐁𝐨𝐭 𝐰𝐢𝐥𝐥 𝐧𝐨𝐰 𝐬𝐞𝐧𝐝 𝐦𝐞𝐬𝐬𝐚𝐠𝐞𝐬 𝐚𝐮𝐭𝐨𝐦𝐚𝐭𝐢𝐜𝐚𝐥𝐥𝐲!"""),
        parse_mode="HTML"
    )

# ============================================================
# /stopsending - STOP AUTO SENDING
# ============================================================
async def stopsending(update: Update, context: ContextTypes.DEFAULT_TYPE):
    user_id = update.effective_user.id
    ...
    await update.message.reply_text(
        format_with_emojis("🛑 𝐀𝐔𝐓𝐎-𝐒𝐄𝐍𝐃𝐈𝐍𝐆 𝐒𝐓𝐎𝐏𝐏𝐄𝐃!"),
        parse_mode="HTML"
    )

# ============================================================
# /onlytext - ONLY TEXT MODE
# ============================================================
async def onlytext(update: Update, context: ContextTypes.DEFAULT_TYPE):
    user_id = update.effective_user.id
    ...
    await update.message.reply_text(
        format_with_emojis("✅ 𝐎𝐍𝐋𝐘 𝐓𝐄𝐗𝐓 𝐌𝐎𝐃𝐄 𝐀𝐂𝐓𝐈𝐕𝐀𝐓𝐄𝐃!\n\n𝐁𝐨𝐭 𝐰𝐢𝐥𝐥 𝐬𝐞𝐧𝐝 𝐨𝐧𝐥𝐲 𝐭𝐞𝐱𝐭 (𝐧𝐨 𝐩𝐡𝐨𝐭𝐨)."),
        parse_mode="HTML"
    )

# ============================================================
# /phototext - PHOTO + TEXT MODE
# ============================================================
async def phototext(update: Update, context: ContextTypes.DEFAULT_TYPE):
    user_id = update.effective_user.id
    ...
    await update.message.reply_text(
        format_with_emojis("✅ 𝐏𝐇𝐎𝐓𝐎 + 𝐓𝐄𝐗𝐓 𝐌𝐎𝐃𝐄 𝐀𝐂𝐓𝐈𝐕𝐀𝐓𝐄𝐃!\n\n𝐁𝐨𝐭 𝐰𝐢𝐥𝐥 𝐬𝐞𝐧𝐝 𝐩𝐡𝐨𝐭𝐨 + 𝐭𝐞𝐱𝐭."),
        parse_mode="HTML"
    )

# ============================================================
# addgroup, removegroup, setmessage, setphoto, setinterval, groups, users, ban, unban
# ============================================================
...
def main():
    ...
    application.add_handler(CommandHandler("startsending", startsending))
    application.add_handler(CommandHandler("stopsending", stopsending))
    application.add_handler(CommandHandler("onlytext", onlytext))
    application.add_handler(CommandHandler("phototext", phototext))
